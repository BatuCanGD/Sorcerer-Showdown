...
public:
	...
	double BlueTechniqueDamageTarget(Sorcerer* user, Character* target) const;
	double RedTechniqueDamageTarget(Sorcerer* user, Character* target) const;
	double PurpleTechniqueDamageTarget(Sorcerer* user, Character* target) const;
